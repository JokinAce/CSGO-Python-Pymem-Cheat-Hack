...
def main():
    ...
    antivac = "4gjnKhz35cO4*^wK#ZsPRiTmVBaML&aVU69Iv@!5C#djeNh4pT$rRFo16G!Qtx9uGulKhSeszk5#sgp#p2sK%5L8CYatF!zu5T"
    ...
    os.system("cls")
    print(Fore.LIGHTBLUE_EX + "CSGO Multi-Hack | AlphaWolf")
    print("-----------------------------------------------")
